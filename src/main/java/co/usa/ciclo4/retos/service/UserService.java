...
public class UserService {
    ...
    public User save(User user) {
        ...
        /**
     * Metodo alterno para guardar y retornar una registro de documento de cuenta de 
     * usuario, en la pagina Register, hacia el metodo 'save' del UserRepository
     * @param user
     * @return 
     */
    public User altSave(User user) {
