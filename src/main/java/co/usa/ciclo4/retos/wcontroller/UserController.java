...
public class UserController {
    ...
    /**
     * Metodo alterno para guardar y retornar un registro de documento de 
     * cuenta de usuario, en la pagina de Register, hacia el metodo 'save' del 
     * UserService
     * @param user
     * @return 
     */
    @PostMapping("/altnew")
    @ResponseStatus(HttpStatus.CREATED)
    public User altSave(@RequestBody User user) {
        return userService.altSave(user);
    }    
